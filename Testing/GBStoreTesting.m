...
- (void)testRegisterClass_shouldAddClassToList {
	...
	XCTAssertEqual([store.classes allObjects].count, (NSUInteger)1);
	XCTAssertEqualObjects([[store.classes allObjects] objectAtIndex:0], class);
}
...
- (void)testRegisterCategory_shouldAddCategoryToList {
	...
	XCTAssertEqual([store.categories allObjects].count, (NSUInteger)1);
	XCTAssertEqualObjects([[store.categories allObjects] objectAtIndex:0], category);
}
...
- (void)testRegisterExtension_shouldAddExtensionToList {
	...
	XCTAssertEqual([store.categories allObjects].count, (NSUInteger)1);
	XCTAssertEqualObjects([[store.categories allObjects] objectAtIndex:0], extension);
}
...
- (void)testRegisterProtocol_shouldAddProtocolToList {
	...
	XCTAssertEqual([store.protocols allObjects].count, (NSUInteger)1);
	XCTAssertEqualObjects([[store.protocols allObjects] objectAtIndex:0], protocol);
}
...
- (void)testRegisterDocument_shouldAddDocumentToList {
	...
	XCTAssertEqual([store.documents allObjects].count, (NSUInteger)1);
	XCTAssertEqualObjects([[store.documents allObjects] objectAtIndex:0], document);
}
...
- (void)testRegisterCustomDocumentWithKey_shouldAddDocumentToList {
	...
	// verify
	XCTAssertEqual(store.customDocuments.count, (NSUInteger)1);
